...
| :--: | :--: | :--: | :--: |
| ![List](assets/screenshots/mobile_light_my-network_created_links_list.png) | ![Grid](assets/screenshots/mobile_light_my-arena_created_embeds_grid.png) | ![All blocks](assets/screenshots/mobile_light_all-arena_created_all.png) | ![Filters](assets/screenshots/mobile_light_all-arena_created_links_list_filter.png) |
...
Once you have followed many users, the feed becomes tricky to navigate. Are.na's explore page and search mitigate this problem well with robust filtering and sorting. In Are.na's iOS app, channels and notifications can be viewed at different densities from list to grids. This feed reader draws inspiration from those solutions and the simple conventions of RSS readers managing firehoses of content in a linear feed.
